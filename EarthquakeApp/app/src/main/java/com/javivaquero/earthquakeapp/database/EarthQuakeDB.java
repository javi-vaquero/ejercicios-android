package com.javivaquero.earthquakeapp.database;
...
public class EarthQuakeDB {
    ...
    private static class EarthQuakeOpenHelper extends SQLiteOpenHelper{
        ...
        private	static final String	DATABASE_CREATE	= "CREATE TABLE " + DATABASE_TABLE +
         "(_id TEXT PRIMARY KEY, place TEXT, magnitude REAL, latitude REAL, longitude REAL, depth REAL, url TEXT, time INTEGER);";
